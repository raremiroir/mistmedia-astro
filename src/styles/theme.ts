	...
	colors: {
		bg: {
			...
			surface: {
				...
				active: 'active:bg-surface-300/80 dark:active:bg-surface-500/40',
			...
			surface_dark: {
				default: 'bg-surface dark:bg-surface-50',
				default_alt: 'bg-gray-900/10 dark:bg-gray-50/10',
				hover: 'hover:bg-surface-600 hover:dark:bg-surface-100',
				hover_alt: 'hover:bg-gray-900/20 hover:dark:bg-gray-50/20',
				active: 'active:bg-surface-700 active:dark:bg-surface-300',
		...
		text: {
			...
			surface_alt: {
				default: 'text-surface-700 dark:text-surface-300',
				hover: 'hover:text-primary-500 dark:hover:text-primary-200',
				active: 'active:text-primary-400 dark:active:text-primary-200',
			},
			surface_dark: {
